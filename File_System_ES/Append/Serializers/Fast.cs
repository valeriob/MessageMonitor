...
namespace DRDigit
{
    ...
    public unsafe sealed partial class Fast
    {
        ...
        public static void FromHexString_ToBuffer(string source, byte[] buffer, int start_Index)
        {
            if (string.IsNullOrEmpty(source))
                return;
            ...
            int index = 0, len = source.Length >> 1; 
